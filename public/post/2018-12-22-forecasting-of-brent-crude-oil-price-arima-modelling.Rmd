...
<p style='text-align: justify;'>**Note:** When we apply **auto.arima()** function on data, we received ARIMA(1,1,0)(0,0,2)[12], which means that the function believes that the series of crude oil price include seasonal component. </p>
