...
<p style='text-align: justify;'>Only part of the variance in the dependent variable will be explained by the values of the independent variable SSR/SST (which is equal to 0.61 in our model). The variance left unexplained is due to the error SSE/SST and this why we should also conduct an analysis over the residulas of our model. The main issue here is to make sure that the residuals are following the main assumptions of the linear regression.</p>
